...
modelo = "./models"
datos_entrenamiento = "./data/datos_canciones.json"
...
def preparar_datos(batch):
    texto = f"Pregunta: {batch['input']}\nRespuesta: {batch['output']['cancion']}"
...
# Guardar el modelo ajustado en la carpeta ./modelo_musica
model.save_pretrained("./modelo_musica")
tokenizer.save_pretrained("./modelo_musica")
print("Entrenamiento completado y modelo guardado en ./modelo_musica")
